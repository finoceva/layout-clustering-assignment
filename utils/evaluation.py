...
def calculate_combined_score(silhouette: float, quality_purity: float, silhouette_weight: float = 0.5) -> float:
    """
...
def evaluate_clustering(X: np.ndarray, cluster_labels: np.ndarray, quality_labels: List[str]) -> dict:
    """
