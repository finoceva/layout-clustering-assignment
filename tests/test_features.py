...
class TestBasicFeatures:
    ...
    def test_basic_features_normal_layout(self, sample_layout: Layout) -> None:
    ...
    def test_basic_features_empty_layout(self, empty_layout: Layout) -> None:
...
class TestSpatialFeatures:
    ...
    def test_spatial_features_normal_layout(self, sample_layout: Layout) -> None:
    ...
    def test_spatial_features_empty_layout(self, empty_layout: Layout) -> None:
...
class TestAlignmentFeatures:
    ...
    def test_alignment_features_normal_layout(self, sample_layout: Layout) -> None:
        """Test alignment features with normal layout."""
        features = calculate_alignment_features(sample_layout)

        required_keys = ["edge_alignment_score", "unique_x_positions", "unique_y_positions", "grid_adherence_score"]
    ...
    def test_alignment_features_single_element(self) -> None:
        """Test alignment features with single element."""
        element = Element(element_class="test", x=100, y=100, width=200, height=100)
        layout = Layout(id="single_element", width=400, height=300, group_id="test", elements=[element], quality="pass")
...
class TestBalanceFeatures:
    ...
    def test_balance_features_normal_layout(self, sample_layout: Layout) -> None:
    ...
    def test_balance_features_centered_layout(self) -> None:
        ...
        layout = Layout(id="centered", width=600, height=400, group_id="test", elements=[element], quality="pass")
...
class TestSpacingFeatures:
    ...
    def test_spacing_features_normal_layout(self, sample_layout: Layout) -> None:
        """Test spacing features with normal layout."""
        features = calculate_spacing_features(sample_layout)

        required_keys = ["avg_spacing", "min_spacing", "spacing_consistency", "whitespace_ratio"]
    ...
    def test_spacing_features_single_element(self) -> None:
        """Test spacing features with single element."""
        element = Element(element_class="single", x=100, y=100, width=200, height=100)
        layout = Layout(id="single", width=400, height=300, group_id="test", elements=[element], quality="pass")
...
class TestHierarchyFeatures:
    ...
    def test_hierarchy_features_normal_layout(self, sample_layout: Layout) -> None:
        """Test hierarchy features with normal layout."""
        features = calculate_hierarchy_features(sample_layout)

        required_keys = ["size_hierarchy", "largest_element_ratio", "size_variance"]
    ...
    def test_hierarchy_features_uniform_sizes(self) -> None:
        """Test hierarchy features with uniform element sizes."""
        elements = [Element(element_class=f"elem_{i}", x=i * 100, y=100, width=80, height=80) for i in range(3)]

        layout = Layout(id="uniform", width=400, height=300, group_id="test", elements=elements, quality="pass")
...
class TestFlowFeatures:
    ...
    def test_flow_features_normal_layout(self, sample_layout: Layout) -> None:
        """Test flow features with normal layout."""
        features = calculate_flow_features(sample_layout)

        required_keys = ["reading_flow_score", "top_left_weight", "scanning_pattern"]
    ...
    def test_flow_features_top_left_heavy(self) -> None:
        ...
        layout = Layout(id="top_left", width=600, height=400, group_id="test", elements=elements, quality="pass")
...
class TestFeatureIntegration:
    ...
    def test_extract_all_features_normal_layout(self, sample_layout: Layout) -> None:
        ...
        feature_categories = [
            ...
            "spatial_spread_x",
            "center_of_mass_x",  # Spatial
            "edge_alignment_score",
            "grid_adherence_score",  # Alignment
            "balance_score",
            "horizontal_balance",  # Balance
            "avg_spacing",
            "whitespace_ratio",  # Spacing
            "size_hierarchy",
            "largest_element_ratio",  # Hierarchy
            "reading_flow_score",
            "top_left_weight",  # Flow
        ]
    ...
    def test_extract_all_features_empty_layout(self, empty_layout: Layout) -> None:
    ...
    def test_feature_extraction_robustness(self) -> None:
